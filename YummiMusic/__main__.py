...
async def init():
    ...
    LOGGER("YummiMusic").info("Yummi Music start /,/ Your Girlfriend Is Very Dangerous /,/isko sambhalna aapki bus ki baat Na hai apni girlfriend ke number Amisha Patel mein fenk Maro")
    await idle()
